...
# Load the data
df = pd.read_csv("ECMO_data_processed_v5_filteredpatients.csv")
...
importance = RF_model.feature_importances_
feature_names = X_train.columns
sorted_idx = np.argsort(importance)[-20:]  # Get the indices of the 20 most important features
...
plt.tight_layout()  # Ensures that the labels fit within the figure
plt.savefig('random_forest_feature_importance_top20.png')
